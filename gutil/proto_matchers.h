...
#ifndef GOOGLE_NETKAT_GUTIL_PROTO_MATCHERS_H
#define GOOGLE_NETKAT_GUTIL_PROTO_MATCHERS_H
  ...
  bool MatchAndExplain(const ProtoType& actual,
    ...
    if (expected_ == nullptr) {
      absl::StatusOr<ProtoType> expected =
          netkat::ParseTextProto<ProtoType>(expected_text_);
      if (expected.ok()) {
...
#endif  // GOOGLE_NETKAT_GUTIL_PROTO_MATCHERS_H
