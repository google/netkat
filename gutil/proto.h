...
#ifndef GOOGLE_NETKAT_GUTIL_PROTO_H
#define GOOGLE_NETKAT_GUTIL_PROTO_H
...
absl::StatusOr<T> ParseJsonAsProto(absl::string_view raw_json_string,
  ...
  RETURN_IF_ERROR(
      netkat::ToAbslStatus(google::protobuf::util::JsonStringToMessage(
...
#endif  // GOOGLE_NETKAT_GUTIL_PROTO_H
