...
class AnalysisEngine {
 public:
  ...
  // `program`, will produce an output less than or equal to `output_packets`.
  //
  // Roughly equivalent to: push(input_packet, program) <= output_packet.
  //
  ...
  //
  // If `strict` is true, then the sets must be exactly equal.
