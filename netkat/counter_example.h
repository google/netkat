...
class CounterExample {
 public:
  ...
  // transformer manager is null or if there is no such packet.
...
class SuccessOrCounterExample {
 public:
  // The default constructor represents no counter example, i.e. the policies
  // are equivalent.
  ...
  static SuccessOrCounterExample Success() { return SuccessOrCounterExample(); }
