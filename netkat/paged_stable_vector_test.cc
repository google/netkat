...
TEST(PagedStableVectorTest, ReferencesDontGetInvalidated) {
  ...
  std::string& first_element = vector[0];
  vector.push_back("second element");
  std::string& second_element = vector[1];
  ...
  first_element = "new first element";
  EXPECT_EQ(vector[0], "new first element");
  second_element = "new second element";
