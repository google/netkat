...
class SymbolicPacketTransformerManager {
 public:
  ...
  // Creates a symbolic packet transformer that accepts a packet iff it is
  // contained in `symbolic_packet` as defined by this object's internal
  // `SymbolicPacketManager`. This is equivalent to Filter on the predicate
  // corresponding to `symbolic_packet`.
