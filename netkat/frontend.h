...
class Predicate {
 ...
 private:
  ...
  Predicate(PredicateProto pred) : predicate_(std::move(pred)) {}
...
//
// Label verification is currently limited. Caution is advised when making
// assumptions on field presence and values, with respect to program
// correctness.
