...
// fixed `PageSize`. This introduces an extra level of indirection, but allows
...
// to the vector.
//
// Allocating memory in pages also reduces the cost of reallocation, which may
// be expensive for very large vectors.
//
